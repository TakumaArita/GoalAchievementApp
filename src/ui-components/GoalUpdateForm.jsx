...
export default function GoalUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setAchieveUntil(cleanValues.AchieveUntil);
    setBehaviorGoal(cleanValues.BehaviorGoal ?? []);
    setCurrentBehaviorGoalValue("");
    setAchieved(cleanValues.Achieved);
    setErrors({});
  };
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          GoalName,
          AchieveUntil: AchieveUntil ?? null,
          BehaviorGoal: BehaviorGoal ?? null,
