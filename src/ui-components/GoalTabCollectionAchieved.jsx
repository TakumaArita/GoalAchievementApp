...
import AchievedGoalTab from "./AchievedGoalTab";
...
export default function GoalTabCollectionAchieved(props) {
  ...
  return (
    <div>
      <Collection
        ...
        {...getOverrideProps(overrides, "GoalTabCollectionAchieved")}
        {...rest}
      >
        {(item, index) => {
          if (loading) {
